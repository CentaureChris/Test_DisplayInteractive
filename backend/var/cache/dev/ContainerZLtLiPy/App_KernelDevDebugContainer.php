...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/CorsSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\CorsSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\CorsSubscriber'] ??= new \App\EventSubscriber\CorsSubscriber()), 'onKernelRequest'], 100);
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\CorsSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\CorsSubscriber'] ??= new \App\EventSubscriber\CorsSubscriber()), 'onKernelResponse'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\CustomerController', 'App\\Controller\\PurchaseController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
